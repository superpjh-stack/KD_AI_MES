...
-- ── 물리 설계 유니크 (TD5 criteria: 물리 제약은 구현 단계 확정) ──
ALTER TABLE SYS_ROLE_PERMISSIONS ADD CONSTRAINT uq_sys_role_permissions_phys UNIQUE NULLS NOT DISTINCT (ROLE_CODE, AREA_CODE, SCREEN_ID);  -- D-45
